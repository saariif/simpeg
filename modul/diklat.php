...
<div class="modal fade" id="pendidikanModal" data-bs-backdrop="static" tabindex="-1">
    ...
    <div class="modal-content">
        ...
        <form class="form">
            ...
            <h5 class="modal-title" id="exampleModalLabel3"><span id="aksi"></span> Diklat</h5>
            <button
                type="button"
                class="btn-close"
            ...
            <div class="row g-2 mb-2">
                <div class="col mb-0">
                    <label for="jenjang" class="form-label">Nama Diklat <font color="red">*</font></label>
                ...
                <div class="col mb-0">
                <label for="no_ijazah" class="form-label">Penyelenggara <font color="red">*</font></label>
            ...
            <div class="row g-2 mb-2">
                <div class="col mb-0">
                    <label for="lembaga" class="form-label">Keterangan <font color="red">*</font></label>
                ...
                <div class="col mb-0">
                    <label for="lulus" class="form-label">Tempat <font color="red">*</font></label>
            ...
            <div class="row g-2 mb-2">
                <div class="col mb-0">
                <label for="status" class="form-label">Tahun <font color="red">*</font></label>
                ...
                <div class="col mb-0">
                    <label for="jurusan" class="form-label">Lama <font color="red">*</font></label>
