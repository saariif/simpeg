...
<div class="modal fade" id="pendidikanModal" data-bs-backdrop="static" tabindex="-1">
    ...
    <div class="modal-content">
        ...
        <form class="form">
            ...
            <h5 class="modal-title" id="exampleModalLabel3"><span id="aksi"></span> Jabatan</h5>
            <button
                type="button"
                class="btn-close"
            ...
            <div class="row g-2 mb-2">
                <div class="col mb-0">
                    <label for="jenjang" class="form-label">Jabatan Utama <font color="red">*</font></label>
                ...
                <div class="col mb-0">
                <label for="no_ijazah" class="form-label">Diperbantukan</label>
            ...
            <div class="row g-2 mb-2">
                <div class="col mb-0">
                    <label for="lembaga" class="form-label">Jabatan Tambahan</label>
                ...
                <div class="col mb-0">
                    <label for="lulus" class="form-label">Keterangan diperbantukan</label>
            ...
            <div class="row g-2 mb-2">
                <div class="col mb-0">
                <label for="status" class="form-label">Bidang Studi</label>
                ...
                <div class="col mb-0">
                    <label for="jurusan" class="form-label">Tunjangan</label>
            ...
            <div class="row g-2 mb-2">
                <div class="col mb-0">
                    <label for="lembaga" class="form-label">Satuan Kerja</label>
                    <input type="text" id="lembaga" placeholder="Nama Sekolah/Universitas" class="form-control" required/>
                    <div id="lembaga_m" class="invalid-feedback"></div>
                </div>
                <div class="col mb-0">
                    <label for="lulus" class="form-label">No SK</label>
                    <input type="text" id="lulus" placeholder="Tahun Lulus" class="form-control" required/>
                    <div id="lulus_m" class="invalid-feedback"></div>
                </div>
            </div>
            <div class="row g-2 mb-2">
                <div class="col mb-0">
                    <label for="lembaga" class="form-label">Keterangan Jabatan</label>
                    <input type="text" id="lembaga" placeholder="Nama Sekolah/Universitas" class="form-control" required/>
                    <div id="lembaga_m" class="invalid-feedback"></div>
                </div>
                <div class="col mb-0">
                    <label for="lulus" class="form-label">Tanggal SK</label>
                    <input type="text" id="lulus" placeholder="Tahun Lulus" class="form-control" required/>
                    <div id="lulus_m" class="invalid-feedback"></div>
                </div>
            </div>
            <div class="row g-2 mb-2">
                <div class="col mb-0">
                    <label for="lembaga" class="form-label">TMT SK</label>
                    <input type="text" id="lembaga" placeholder="Nama Sekolah/Universitas" class="form-control" required/>
                    <div id="lembaga_m" class="invalid-feedback"></div>
                </div>
                <div class="col mb-0">
                    <label for="lulus" class="form-label">Pangkat</label>
                    <input type="text" id="lulus" placeholder="Tahun Lulus" class="form-control" required/>
                    <div id="lulus_m" class="invalid-feedback"></div>
                </div>
            </div>
            <div class="row">
                <div class="col mb-2">
                <label for="nama" class="form-label">Dokumen Jabatan <font color="red">*</font></label>
                <input type="file" id="nama" class="form-control" placeholder="Nama Keluarga" required/>
