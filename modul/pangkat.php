    ...
    <div class="col-md-12">
        <div class="card">
            <ul class="card-header nav nav-pills" role="tablist" id="data">
                <li class="nav-item">
                <button
                    id="btn-tambah" type="button" class="nav-link active" data-bs-toggle="modal" data-bs-target="#pendidikanModal">
...
<div class="modal fade" id="pendidikanModal" data-bs-backdrop="static" tabindex="-1">
    ...
    <div class="modal-content">
        ...
        <form class="form">
            ...
            <h5 class="modal-title" id="exampleModalLabel3"><span id="aksi"></span> Pangkat</h5>
            <button
                type="button"
                class="btn-close"
            ...
            <div class="row g-2 mb-2">
                <div class="col mb-0">
                    <label for="jenjang" class="form-label">Jenis SK <font color="red">*</font></label>
                ...
                <div class="col mb-0">
                <label for="no_ijazah" class="form-label">No SK <font color="red">*</font></label>
            ...
            <div class="row g-2 mb-2">
                <div class="col mb-0">
                    <label for="lembaga" class="form-label">Pangkat <font color="red">*</font></label>
                ...
                <div class="col mb-0">
                    <label for="lulus" class="form-label">TMT SK <font color="red">*</font></label>
            ...
            <div class="row g-2 mb-2">
                <div class="col mb-0">
                <label for="status" class="form-label">Masa Kerja <font color="red">*</font></label>
                ...
                <div class="col mb-0">
                    <label for="jurusan" class="form-label">Tgl SK <font color="red">*</font></label>
            ...
            <div class="row g-2 mb-2">
                <div class="col mb-0">
                    <label for="lembaga" class="form-label">Gaji Pokok <font color="red">*</font></label>
                    <input type="text" id="lembaga" placeholder="Nama Sekolah/Universitas" class="form-control" required/>
                    <div id="lembaga_m" class="invalid-feedback"></div>
                </div>
                <div class="col mb-0">
                    <label for="lulus" class="form-label">Masa Kerja <font color="red">*</font></label>
                    <input type="text" id="lulus" placeholder="Tahun Lulus" class="form-control" required/>
                    <div id="lulus_m" class="invalid-feedback"></div>
                </div>
            </div>
            <div class="row">
                <div class="col mb-2">
                <label for="nama" class="form-label">Dokumen <font color="red">*</font></label>
