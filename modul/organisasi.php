...
<div class="modal fade" id="keluargaModal" data-bs-backdrop="static" tabindex="-1">
    ...
    <div class="modal-content">
        ...
        <form class="form" id="myForm" enctype="multipart/form-data">
            <input type="hidden" id="id" />
            <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel3"><span id="aksi"></span> Riwayat Organisasi</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
            <div class="row">
            ...
            <div class="row">
                <div class="col mb-2">
                <label for="nama" class="form-label">Kedudukan</label>
                <input type="text" id="nama" name="nama" class="form-control" placeholder="Nama Keluarga" required/>
                <div id="nama_m" class="invalid-feedback"></div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col mb-2">
                <label for="nama" class="form-label">Dokumen Organisasi</label>
